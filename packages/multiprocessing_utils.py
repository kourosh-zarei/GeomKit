...
def ray_to_mesh_points(ray: Line, points_density_for_line, camera_radius, subject_radius):
    return ray.to_mesh(points_density_for_line, camera_radius, subject_radius)
